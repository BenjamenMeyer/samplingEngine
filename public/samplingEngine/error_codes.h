...
#define SAMPLING_ENGINE_ERROR_TOO_MANY_TIME_CHANNELS     (0x0000000C) /*!< Time channel count will overrun the record size storage capacity */
#define SAMPLING_ENGINE_ERROR_TOO_MANY_DISTNACE_CHANNELS (0x0000000D) /*!< Distance channel count will overrun the record size storage capacity */
